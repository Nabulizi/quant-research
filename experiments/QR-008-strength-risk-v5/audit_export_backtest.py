# QR-008 audit export as a BACKTEST (for workflows without research
# notebooks; Object Store web download is tier-gated). Reads
# qr008/results.json (written by valid run 9bb76ea828c3f4e8575e097a8b973ca3)
...
class QR008AuditExport(QCAlgorithm):
    ...
    def initialize(self):
        ...
        raw = self.object_store.read("qr008/results.json")
        d = json.loads(raw)
        ...
        payload = {
            ...
            "insuf": [r["insufficient"] for r in d["records"]][:months],
            "buckets": buckets,
